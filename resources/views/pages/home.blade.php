...
<img class="img-header" src="asset/foto.png">
    </div>
    <section class="ourwork">
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <h1>Our Work</h1>
            <p>Community Change” is both our name and a statement of our purpose. Our goal is to dramatically improve material conditions for people struggling to make ends meet in the United States, and we have a 15-year plan to do so. On the path ahead, our role is to fuse the power of organized people, bold ideas, and political clout — a three-dimensional power that we believe is the recipe for an economy and democracy where everyone can thrive ommunity Change” is both our name and a statement of our purpose. Our goal is to dramatically improve material conditions for people struggling to make ends meet in the United States, and we have a 15-year plan to do so. On the path ahead, our role is to fuse the power of organized people, bold ideas, and political clout — a three-dimensional power that we believe is the recipe for an economy and democracy where everyone can thrive.</p>
          </div>
          <div class="col-sm-8">
            <div class="list-ourwork">
              
              <span class="ourwork-caption">Voter Engaagement </span>
            </div>
            <div class="list-ourwork">
             <span class="ourwork-caption">Immigrant Rights </span>

            </div>
            <div class="list-ourwork">
              
<span class="ourwork-caption">Child Care Justice </span>
            </div>
          </div>
    ...
    <section class="change bg-light py-5">
      <div class="container">
        <h2>
        change wire
      </h2>
      ...
      <div class="list-change d-flex">
        <div class="card" style="width: 20rem;">
  <img src="asset/starup.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Stories</h5>
  </div>
</div>
  <div class="card" style="width: 20rem;">
  <img src="asset/learner.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Podcast</h5>
  </div>
</div>
<div class="card" style="width: 20rem;">
  <img src="asset/movies.png" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="card" style="width: 20rem;">
  ...
  <div class="card-body">
    ...
    <section class="community py-5">
      <div class="container">
      <img src="asset/future.jpg" class="list-community">
    </div>
    </section>
