                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title ">List Newsletters</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-right">
                                                        ...
                                                        <a
                                                            onclick="return confirm('Yakin untuk menghapus newsletters {{$item->title}}? ')">
                                                            <form action="{{ route('newsletters.destroy', $item->id) }}"
